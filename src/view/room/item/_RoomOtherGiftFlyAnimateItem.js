...
import { EVT_LOGIC_UPDATE_OTHER_PERSON_GIFT_FLY } from "../../../hardcode/HLogicEvent";

export default class _RoomOtherGiftFlyAnimateItem extends PureComponent {
    ...
    componentDidMount() {
        ModelEvent.addEvent(null, EVT_LOGIC_UPDATE_OTHER_PERSON_GIFT_FLY, this._handleFlyData)
    }


    componentWillUnmount() {
        ModelEvent.removeEvent(null, EVT_LOGIC_UPDATE_OTHER_PERSON_GIFT_FLY, this._handleFlyData)
    }
...
class FlyImage extends PureComponent {
    ...
    constructor(props) {
        ...
        this._top = DesignConvert.getH(20);
    }
