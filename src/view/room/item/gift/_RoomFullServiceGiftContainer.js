...
import { EVT_LOGIC_UPDATE_FULL_SERVICE_GIFT_BANNER } from "../../../../hardcode/HLogicEvent";
import { View } from "react-native";
import _RoomFullServiceGiftItem from "./_RoomFullServiceGiftItem";

export default class _RoomFullServiceGiftContainer extends PureComponent {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ModelEvent.addEvent(null, EVT_LOGIC_UPDATE_FULL_SERVICE_GIFT_BANNER, this._onData);
    }

    componentWillUnmount() {
        ModelEvent.removeEvent(null, EVT_LOGIC_UPDATE_FULL_SERVICE_GIFT_BANNER, this._onData);
        this._stopCheckShow();
        this._listData = null;
        this._showingItems = null;
        this._showingItemMap = null;
