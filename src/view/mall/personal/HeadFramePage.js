...
import { getUserHeadData } from "../../../cache/MallCache";
        ...
        return (
            ...
            >
                ...
                <Image
                    ...
                    source={{ uri: Config.getShopHeadFrameIdUrl(this.props.info.hdata.avatarboxid, this.props.info.hdata.updatetime) }}
                />
                ...
                >{this.props.info.hdata.name}</Text>
...
class _BuyBottomItem extends Component {
    ...
    _updateList(props) {
        this._list = require('../../../model/mall/MallModel').getHeadFramePriceChooseList(props.info.hdata);
    ...
    _onBuy = () => {
        require('../../../model/mall/MallModel').buyHeadFrame(this.props.info.hdata.avatarboxid, this._selectedData.timeType)
            .then(bSuc => {
                if (bSuc) {
...
export default class HeadFramePage extends PureComponent {
    ...
    _updateInfo = () => {
        require("../../../model/mall/MallModel").getMyHeadFrameData()
            .then(datas => {
                this.forceUpdate();
            });
    }
    ...
    _onItemPress = (info) => {
        require("../../../model/mall/MallModel").pressHeadFrame(info);
