...
@interface RCTImageView () <CAAnimationDelegate>
...
@property (nonatomic, copy) RCTDirectEventBlock onMovieEnd;
...
- (void)imageLoaderLoadedImage:(UIImage *)loadedImage error:(NSError *)error forImageSource:(RCTImageSource *)source partial:(BOOL)isPartialLoad
{
  ...
  void (^setImageBlock)(UIImage *) = ^(UIImage *image) {
    ...
    if (isPartialLoad) {
      ...
      if (self->_onLoad) {
        RCTImageSource *sourceLoaded = [source imageSourceWithSize:image.size scale:source.scale extraData:source.extraData];
...
//    NSLog(@"这个动画结束了");
    _imageView.image = [_imageView.image.images lastObject];
    [_imageView.layer removeAnimationForKey:@"customType"];
