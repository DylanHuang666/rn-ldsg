...
RCT_EXPORT_METHOD(updateLayoutDirection) {
    YGDirection baseDirection = [[RCTI18nUtil sharedInstance] isRTL] ? YGDirectionRTL : YGDirectionLTR;
    for (NSNumber* reactTag in _shadowViewRegistry) {
        RCTShadowView * v = _shadowViewRegistry[reactTag];
        v.direction = baseDirection;
    }
}
