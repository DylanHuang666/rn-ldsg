      ...
      mControllerListener = new BaseControllerListener<ImageInfo>() {
        ...
        public void onFinalImageSet(
          ...
          if (animatable instanceof AnimatedDrawable2) {
            final int totalCnt = ((AnimatedDrawable2) animatable).getFrameCount();
            ((AnimatedDrawable2) animatable).setAnimationListener(new BaseAnimationListener() {
              private int lastFrame;

              @Override
              public void onAnimationStop(AnimatedDrawable2 drawable) {
                mEventDispatcher.dispatchEvent(new ImageLoadEvent(getId(), ImageLoadEvent.ON_MOVIE_END));
              }
