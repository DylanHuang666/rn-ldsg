...
public class ReactScrollViewManager
  ...
  public void setVerticalFadingEdgeEnabled(ReactScrollView view, String val){
    if("vertical".equals(val)){
      view.setVerticalFadingEdgeEnabled(true);
      view.setHorizontalFadingEdgeEnabled(false);
    }else if("horizontal".equals(val)){
  ...
  @ReactProp(name = "fadingEdgeLength", defaultInt = 50)
  public void setVerticalFadingEdgeEnabled(ReactScrollView view, int length){
