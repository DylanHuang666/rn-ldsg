  ...
  public void invoke(JSInstance jsInstance, ReadableArray parameters) {
    ...
    try {
      ...
      try {
        ...
        try {
          Class CrashReport =  Class.forName("com.tencent.bugly.crashreport.CrashReport");
          Method postCatchedException = CrashReport.getDeclaredMethod("postCatchedException", Throwable.class);
          postCatchedException.invoke(null, new Exception(traceName + " Exception"));
        } catch (Exception e1) {

        }
        Log.e(ReactConstants.TAG, traceName + " Exception");
        ex.printStackTrace();
        return;
      }
