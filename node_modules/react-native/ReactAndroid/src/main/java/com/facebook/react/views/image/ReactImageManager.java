...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
  ...
  @ReactProp(name = "loop")
  public void setLoop(ReactImageView view, int loop) {
    view.setLoopCount(loop);
  }
  ...
  public @Nullable Map getExportedCustomDirectEventTypeConstants() {
    return MapBuilder.of(
      ...
      ImageLoadEvent.eventNameForType(ImageLoadEvent.ON_MOVIE_END),
        MapBuilder.of("registrationName", "onMovieEnd"));
  }
