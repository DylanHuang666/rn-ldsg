...
//                .put(RCTSVGAImageView.EVT_FRAME, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", RCTSVGAImageView.EVT_FRAME)))
//                .put(RCTSVGAImageView.EVT_REPEAT, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", RCTSVGAImageView.EVT_REPEAT)))
//                .put(RCTSVGAImageView.EVT_PAUSE, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", RCTSVGAImageView.EVT_PAUSE)))
//                .put(RCTSVGAImageView.EVT_FINISHED, MapBuilder.of("phasedRegistrationNames", MapBuilder.of("bubbled", RCTSVGAImageView.EVT_FINISHED)))
//                .build();
//    }
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        builder.put(RCTSVGAImageView.EVT_FRAME,MapBuilder.of("registrationName", RCTSVGAImageView.EVT_FRAME));
        builder.put(RCTSVGAImageView.EVT_REPEAT,MapBuilder.of("registrationName", RCTSVGAImageView.EVT_REPEAT));
        builder.put(RCTSVGAImageView.EVT_PAUSE,MapBuilder.of("registrationName", RCTSVGAImageView.EVT_PAUSE));
        builder.put(RCTSVGAImageView.EVT_FINISHED,MapBuilder.of("registrationName", RCTSVGAImageView.EVT_FINISHED));
